...
export declare const useColors: () => {
    ...
    getBoxShadowColor: (color: string, opacity?: number) => string;
    getBoxShadowColorFromBg: (background: string, opacity?: number) => string;
    getHoverColor: (color: string, opacity?: number) => string;
    getFocusColor: (color: string, opacity?: number) => string;
    getGradientBackground: (color: string) => string;
    getTextColor: (color: ColorInput, darkColor?: string, lightColor?: string) => string;
    shiftHSLAColor: (color: string | import("../utils/color").RGBObject | import("../utils/color").HSLObject, shift: {
        h?: number | undefined;
        s?: number | undefined;
        l?: number | undefined;
        a?: number | undefined;
    }) => string;
    setHSLAColor: (color: string | import("../utils/color").RGBObject | import("../utils/color").HSLObject, shift: {
        h?: number | undefined;
        s?: number | undefined;
        l?: number | undefined;
        a?: number | undefined;
