export declare const TELEPORT_FROM_ATTR = "data-va-teleported-from";
export declare const TELEPORT_ATTR = "data-va-teleported";
export declare const findTeleportedFrom: (el: HTMLElement | undefined | null) => HTMLElement | null;
/**
 ...
 */
export declare const useTeleported: () => {
    teleportFromAttrs: {
    ...
    findTeleportedFrom: (el: HTMLElement | undefined | null) => HTMLElement | null;
};
