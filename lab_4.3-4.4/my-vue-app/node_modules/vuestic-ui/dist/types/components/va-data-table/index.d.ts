export declare const VaDataTable: <Item extends Record<string, any>>(__VLS_props: {
    ...
    slots: Partial<Record<NonNullable<string | number>, (_: any) => any>> & Partial<Record<`cell(${string})`, (_: {
        row: import("./types").DataTableRow<Item>;
        isExpanded: boolean;
        rowIndex: number;
        rowKey: any;
        rowData: Item;
        ...
        colgroup?(_: {
            ...
            toReversed(): import("./types").DataTableColumnInternal[];
            toSorted(compareFn?: ((a: import("./types").DataTableColumnInternal, b: import("./types").DataTableColumnInternal) => number) | undefined): import("./types").DataTableColumnInternal[];
            toSpliced(start: number, deleteCount: number, ...items: import("./types").DataTableColumnInternal[]): import("./types").DataTableColumnInternal[];
            toSpliced(start: number, deleteCount?: number | undefined): import("./types").DataTableColumnInternal[];
            with(index: number, value: import("./types").DataTableColumnInternal): import("./types").DataTableColumnInternal[];
        ...
        cell?(_: {
            cell: import("./types").DataTableCell<Item>;
            row: import("./types").DataTableRow<Item>;
        }): any;
        expandableRow?(_: {
            initialIndex: number;
            itemKey: any;
            source: Item;
            cells: import("./types").DataTableCell<Item>[];
            rowData: Item;
