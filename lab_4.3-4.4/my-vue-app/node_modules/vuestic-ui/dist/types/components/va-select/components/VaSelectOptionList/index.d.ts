export declare const VaSelectOptionList: {
    new (...args: any[]): import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        ...
        searchFn: {
            type: import("vue").PropType<(search: string, option: import("../..").SelectOption) => boolean>;
            default: undefined;
        };
        delay: {
        ...
        searchFn: (search: string, option: import("../..").SelectOption) => boolean;
        hoveredOption: import("../..").SelectOption;
