...
import { _ as _sfc_main$1 } from "./components/VaInputLabel.vue_vue_type_script_setup_true_lang.mjs";
import { V as VaIcon } from "../va-icon/index.mjs";
import { u as useInputFieldAriaProps, a as useInputFieldAria } from "./hooks/useInputFieldAria.mjs";
import { p as pick } from "../../utils/pick.mjs";
import { W as WithSlotInheritance } from "../../utils/with-slot-inheritance/with-slot-inheritance.mjs";
...
import { b as useValidationProps } from "../../composables/useValidation.mjs";
...
const VaInputLabelProps = extractComponentProps(_sfc_main$1);
const _sfc_main = defineComponent({
  name: "VaInputWrapper",
  components: { VaMessageList: WithSlotInheritance(VaMessageList), VaIcon, VaInputLabel: _sfc_main$1 },
  props: {
