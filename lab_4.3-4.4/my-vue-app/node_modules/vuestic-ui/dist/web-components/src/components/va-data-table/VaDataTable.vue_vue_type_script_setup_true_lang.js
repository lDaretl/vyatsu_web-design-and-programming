...
import { c as createRowsProps, u as useRows } from "./hooks/useRows.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "30b650ee": unref(CSSVariables).selectedColor,
      "40063db4": unref(CSSVariables).hoverColor,
      "586bd4d6": unref(CSSVariables).tableHeight,
      "e5b4a30c": unref(CSSVariables).theadBg,
      "eb60fcf0": unref(CSSVariables).tfootBg,
      "05bdeaf3": gridColumnsCount.value
    }));
...
//# sourceMappingURL=VaDataTable.vue_vue_type_script_setup_true_lang.js.map
