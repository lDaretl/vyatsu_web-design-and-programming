import { defineComponent, useCssVars, unref, computed, ref, watch, openBlock, createElementBlock, normalizeClass, normalizeStyle, createBlock, renderSlot, normalizeProps, mergeProps, createVNode } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    useCssVars((_ctx) => ({
      "3e3d289c": backgroundColorComputed.value,
      "f1b313da": unref(textColorComputed),
      "7b9b6d04": unref(sizeComputed)
    }));
    const props = __props;
    const emit = __emit;
...
//# sourceMappingURL=VaAvatar.vue_vue_type_script_setup_true_lang.js.map
