import { defineComponent, useCssVars, unref, computed, toRefs, shallowRef, openBlock, createBlock, resolveDynamicComponent, mergeProps, withCtx, createElementVNode, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, createCommentVNode, createVNode } from "vue";
...
import { p as pick } from "../../utils/pick.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    useCssVars((_ctx) => ({
      "2dc0cb44": unref(backgroundColor),
      "18555027": unref(backgroundColorOpacity),
      "03936f38": unref(backgroundMaskColor),
      "2f58d2c0": unref(backgroundMaskOpacity)
    }));
    const props = __props;
...
//# sourceMappingURL=VaButton.vue_vue_type_script_setup_true_lang.js.map
